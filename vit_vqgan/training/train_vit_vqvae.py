...
class TrainingArguments:
    ...
    def __post_init__(self):
        if self.assert_TPU_available:
            sys.stdout.write(jax.local_device_count())
...
class DataTrainingArguments:
    ...
    image_size: Optional[int] = field(default=128, metadata={"help": " The size (resolution) of each image."})
